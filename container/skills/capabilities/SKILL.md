---
name: capabilities
description: Show what this ConClaw instance can do — installed skills, available tools, and system info. Read-only. Use when the user asks what the bot can do, what's installed, or runs /capabilities.
---

# /capabilities — System Capabilities Report

Generate a structured read-only report of what this ConClaw instance can do.
...
- **MCP:** mcp__conclaw__* (messaging, tasks, group management)

### 3. MCP server tools

The ConClaw MCP server exposes these tools (via `mcp__conclaw__*` prefix):
